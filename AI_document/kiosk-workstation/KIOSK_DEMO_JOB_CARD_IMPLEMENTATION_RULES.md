...
Version: 1.0Status: ACTIVETarget: S-Factory MES EnterpriseApplies to: Phase 00 through Phase 08
...
Current API validation and responses.

Current Kafka and outbox contracts.

Current seed.

Maintained integration tests.

Maintained browser E2E.

Approved reports and architecture documents.

Current Kiosk reference document.
