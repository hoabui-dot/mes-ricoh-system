...
- Run ID: PHASE2-RP-1786065299147-0D71N
- Status: PASS_FOR_PHASE_2_WITH_PRINT_STATION_SKIPPED
- Target date: 2026-08-07
- Artifact JSON: /home/neurosus/recoh-system/mes-system/artifacts/mes-resource-planning-full-flow/PHASE2-RP-1786065299147-0D71N/phase2-full-flow.json
...
| retrieve side-effect-free backend proposals for every operation | PASSED |  |
| retrieve candidates and commit one Ready candidate for every operation | PASSED |  |
| verify canonical print-station readiness for exact allocated print workstations | PASSED |  |
| refresh committed snapshots and revalidate allocations | SKIPPED |  |
| approve Work Order with strict resource-allocation policy | SKIPPED |  |
| start execution | SKIPPED |  |
| verify allocation reservation audit and outbox persistence | SKIPPED |  |
