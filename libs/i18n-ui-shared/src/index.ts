...
export const commonResources: ResourceBundle = {
  vi: {
    ...
    'common.code': 'Mã',
    'common.area': 'Khu vực', 'common.confirm': 'Xác nhận', 'common.deactivate': 'Ngừng hoạt động', 'common.back': 'Quay lại', 'common.loading': 'Đang tải',
    'common.name': 'Tên',
    'common.type': 'Loại',
    'common.all': 'Tất cả',
  ...
  en: {
    ...
    'common.code': 'Code',
    'common.area': 'Area', 'common.confirm': 'Confirm', 'common.deactivate': 'Deactivate', 'common.back': 'Back', 'common.loading': 'Loading',
    'common.name': 'Name',
    'common.type': 'Type',
    'common.all': 'All',
  ...
  ja: {
    ...
    'common.status': 'ステータス',
    'common.code': 'コード',
    'common.area': 'エリア', 'common.confirm': '確認', 'common.deactivate': '無効化', 'common.back': '戻る', 'common.loading': '読み込み中',
    'common.name': '名称',
    'common.type': '種別',
    'common.all': 'すべて',
    'common.active': '有効',
  ...
  ko: {
    ...
    'common.status': '상태',
    'common.code': '코드',
    'common.area': '구역', 'common.confirm': '확인', 'common.deactivate': '비활성화', 'common.back': '뒤로', 'common.loading': '로드 중',
    'common.name': '이름',
    'common.type': '유형',
    'common.all': '전체',
    'common.active': '활성',
