...
export const commonResources: ResourceBundle = {
  vi: {
    ...
    'common.code': 'Mã',
    'common.area': 'Khu vực', 'common.confirm': 'Xác nhận', 'common.deactivate': 'Ngừng hoạt động', 'common.back': 'Quay lại', 'common.loading': 'Đang tải', 'common.delete': 'Xóa', 'common.search': 'Tìm kiếm', 'common.empty': 'Không có dữ liệu', 'common.notAvailable': 'Chưa có dữ liệu', 'common.detail': 'Chi tiết',
    'table.previous': 'Trang trước', 'table.next': 'Trang sau', 'table.rowsPerPage': 'Số dòng mỗi trang', 'table.page': 'Trang {{page}} / {{pages}}', 'table.noRows': 'Không có dòng dữ liệu', 'table.range': '{{from}}-{{to}} trên tổng {{total}}',
    'common.name': 'Tên',
    'common.type': 'Loại',
    'common.all': 'Tất cả',
  ...
  en: {
    ...
    'common.code': 'Code',
    'common.area': 'Area', 'common.confirm': 'Confirm', 'common.deactivate': 'Deactivate', 'common.back': 'Back', 'common.loading': 'Loading', 'common.delete': 'Delete', 'common.search': 'Search', 'common.empty': 'No data', 'common.notAvailable': 'Not available', 'common.detail': 'Details',
    'table.previous': 'Previous', 'table.next': 'Next', 'table.rowsPerPage': 'Rows per page', 'table.page': 'Page {{page}} / {{pages}}', 'table.noRows': 'No rows', 'table.range': '{{from}}-{{to}} of {{total}}',
    'common.name': 'Name',
    'common.type': 'Type',
    'common.all': 'All',
  ...
  ja: {
    ...
    'common.status': 'ステータス',
    'common.code': 'コード',
    'common.area': 'エリア', 'common.confirm': '確認', 'common.deactivate': '無効化', 'common.back': '戻る', 'common.loading': '読み込み中', 'common.delete': '削除', 'common.search': '検索', 'common.empty': 'データなし', 'common.notAvailable': '利用不可', 'common.detail': '詳細',
    'table.previous': '前へ', 'table.next': '次へ', 'table.rowsPerPage': '1ページの行数', 'table.page': 'ページ {{page}} / {{pages}}', 'table.noRows': '行がありません', 'table.range': '{{total}}件中 {{from}}-{{to}}',
    'common.name': '名称',
    'common.type': '種別',
    'common.all': 'すべて',
    'common.active': '有効',
  ...
  ko: {
    ...
    'common.status': '상태',
    'common.code': '코드',
    'common.area': '구역', 'common.confirm': '확인', 'common.deactivate': '비활성화', 'common.back': '뒤로', 'common.loading': '로드 중', 'common.delete': '삭제', 'common.search': '검색', 'common.empty': '데이터 없음', 'common.notAvailable': '사용할 수 없음', 'common.detail': '상세',
    'table.previous': '이전', 'table.next': '다음', 'table.rowsPerPage': '페이지당 행 수', 'table.page': '페이지 {{page}} / {{pages}}', 'table.noRows': '행이 없습니다', 'table.range': '전체 {{total}}개 중 {{from}}-{{to}}',
    'common.name': '이름',
    'common.type': '유형',
    'common.all': '전체',
    'common.active': '활성',
