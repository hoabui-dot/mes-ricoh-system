...
export const TABLES: TableDefinition[] = [
  ...
  { resource: 'items', tableName: 'md_item' },
  {
    ...
    eventType: 'MES.MasterData.ItemRevisionReleased.v1',
  ...
  },
  {
    ...
    eventType: 'MES.MasterData.MBOMReleased.v1',
  ...
  { resource: 'work-instructions', tableName: 'md_work_instruction' },
  {
    ...
    eventType: 'MES.MasterData.WorkCenterActivated.v1',
  ...
  { resource: 'workstations', tableName: 'md_workstation' },
  {
    ...
    eventType: 'MES.MasterData.EquipmentActivated.v1',
